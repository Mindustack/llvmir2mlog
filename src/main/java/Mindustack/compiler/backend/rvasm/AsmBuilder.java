...
//                new AsmLuiInst(luiReg, new GlobalAddr(globalReg, GlobalAddr.HiLo.hi), cur.block);
                new AsmStoreInst(inst.storeValue().type.size(), (Register) inst.storePtr().asmOperand, cur.toReg(inst.storeValue()), cur.toImm(0), cur.block);
            }
        } else {
