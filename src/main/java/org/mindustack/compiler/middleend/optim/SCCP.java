...
import org.mindustack.compiler.middleend.llvmir.constant.*;
...
import org.mindustack.compiler.middleend.llvmir.inst.*;
import org.mindustack.compiler.middleend.llvmir.type.NumType;
import org.mindustack.compiler.share.error.codegen.InternalError;
...
import org.mindustack.compiler.share.warn.ZeroDivisionWarning;
...
public class SCCP implements IRFuncPass, IRBlockPass, InstVisitor {
    ...
    private final org.mindustack.compiler.middleend.llvmir.constant.BaseConst uncertain = new org.mindustack.compiler.middleend.llvmir.constant.BaseConst(LLVM.UncertainConst, null);
    /**
     ...
     */
    private final Map<Value, org.mindustack.compiler.middleend.llvmir.constant.BaseConst> lattice = new HashMap<>();
    ...
    private void assign(Value dest, Value src) {
        org.mindustack.compiler.middleend.llvmir.constant.BaseConst srcConst = getConst(src);
        if (srcConst == uncertain && getConst(dest) != uncertain) {
            ...
            if (getConst(dest) == null) {
                int result;
                org.mindustack.compiler.middleend.llvmir.constant.BaseConst replace = null;
    ...
    private boolean removeRedundantInst(IRFunction function) {
        ...
        for (IRBlock block : function.blocks) {
            ...
            while (it.hasNext()) {
                var inst = it.next();
                org.mindustack.compiler.middleend.llvmir.constant.BaseConst instConst = getConst(inst);
                ...
                if (inst instanceof IRMoveInst) {
                    org.mindustack.compiler.middleend.llvmir.constant.BaseConst destConst = getConst(((IRMoveInst) inst).dest());
            ...
            while (phiIt.hasNext()) {
                var phi = phiIt.next();
                org.mindustack.compiler.middleend.llvmir.constant.BaseConst instConst = getConst(phi);
                if (instConst != null && instConst != uncertain) {
                    ret = true;
                    phiIt.remove();
                }
    ...
    private org.mindustack.compiler.middleend.llvmir.constant.BaseConst getConst(Value value) {
        if (value instanceof org.mindustack.compiler.middleend.llvmir.constant.BaseConst) {
            if (value instanceof GlobalValue) return uncertain;
            return (org.mindustack.compiler.middleend.llvmir.constant.BaseConst) value;
        }
    ...
    private boolean rewriteBranch(IRFunction function) {
        ...
        for (IRBlock block : function.blocks) {
            ...
            org.mindustack.compiler.middleend.llvmir.constant.BaseConst condConst = getConst(((IRBrInst) terminator).condition());
    ...
    public void visit(IRBinaryInst inst) {
        org.mindustack.compiler.middleend.llvmir.constant.BaseConst replace = null;
        org.mindustack.compiler.middleend.llvmir.constant.BaseConst lhsConst = getConst(inst.lhs()), rhsConst = getConst(inst.rhs());
    ...
    public void visit(IRBrInst inst) {
        ...
        org.mindustack.compiler.middleend.llvmir.constant.BaseConst condConst = getConst(inst.condition());
    ...
    public void visit(IRPhiInst inst) {
        org.mindustack.compiler.middleend.llvmir.constant.BaseConst first = getConst(inst.getOperand(0));
