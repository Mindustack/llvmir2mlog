...
import org.mindustack.LLVMIR.LLVMIRBaseVisitor;
import org.mindustack.LLVMIR.LLVMIRLexer;
import org.mindustack.LLVMIR.LLVMIRParser;
...
import org.mindustack.compiler.middleend.llvmir.type.*;
import org.mindustack.compiler.middleend.rewrite.Rewriter;
import org.mindustack.compiler.share.error.InternalError;
    ...
    public Value visitStructConst(LLVMIRParser.StructConstContext ctx) {
        ...
        for (var c : ctx.typeConst()) {
            ...
            if (value instanceof org.mindustack.compiler.middleend.llvmir.constant.BaseConst) {
                structConst.constData.add((org.mindustack.compiler.middleend.llvmir.constant.BaseConst) value);
            } else {
