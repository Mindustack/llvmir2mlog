package org.mindustack.compiler.backend.rvasm;
...
import org.mindustack.compiler.backend.rvasm.hierarchy.AsmModule;
import org.mindustack.compiler.backend.rvasm.inst.*;
import org.mindustack.compiler.backend.rvasm.operand.*;
...
import org.mindustack.compiler.middleend.llvmir.type.IRFuncType;
...
import org.mindustack.compiler.share.pass.IRModulePass;
...
//                //                     spill
    ...
    private void globalDecl(IRModule irModule) {
        ...
        for (GlobalVariable globalVar : irModule.globalVarSeg) {
            ...
            if (globalVar.initValue != null) {
                memUse += parseConst(((org.mindustack.compiler.middleend.llvmir.constant.BaseConst) globalVar.initValue), memUse);
            }
    ...
    private int parseConst(org.mindustack.compiler.middleend.llvmir.constant.BaseConst baseConst, int adrs) {
        ...
        if (baseConst instanceof NumConst || baseConst instanceof BoolConst) {
            ...
            for (org.mindustack.compiler.middleend.llvmir.constant.BaseConst constData : ((ArrayConst) baseConst).constData) {
