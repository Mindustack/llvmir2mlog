package org.mindustack.compiler.backend.regalloc;

import org.mindustack.compiler.backend.analyzer.LivenessAnalyzer;
...
import org.mindustack.compiler.backend.rvasm.inst.AsmLoadInst;
import org.mindustack.compiler.backend.rvasm.inst.AsmMoveInst;
import org.mindustack.compiler.backend.rvasm.inst.AsmStoreInst;
import org.mindustack.compiler.backend.rvasm.operand.PhysicalReg;
import org.mindustack.compiler.backend.rvasm.operand.RawStackOffset;
import org.mindustack.compiler.backend.rvasm.operand.RawStackOffset.RawType;
import org.mindustack.compiler.backend.rvasm.operand.Register;
import org.mindustack.compiler.backend.rvasm.operand.VirtualReg;
...
import org.mindustack.compiler.share.pass.AsmModulePass;
import org.mindustack.debug.Log;
import org.mindustack.debug.Statistics;
...
public class RegisterAllocator implements AsmModulePass, AsmFuncPass {
    ...
    private boolean ok(Register t, Register r) {
        return t.node.degree < K || t.node.precolored || G.adjSet.contains(new InterferenceGraph.Edge(t, r));
    }
