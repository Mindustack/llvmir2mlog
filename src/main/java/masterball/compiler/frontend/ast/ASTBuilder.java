...
public class ASTBuilder extends MxStarBaseVisitor<BaseNode> {
    ...
    @Override
    public BaseNode visitMxStarCode(MxStarParser.MxStarCodeContext ctx) {
...
//        );
    ...
    @Override
    public BaseNode visitClassDef(MxStarParser.ClassDefContext ctx) {
        Log.track("class def");
    ...
    @Override
    public BaseNode visitClassConstructorDef(MxStarParser.ClassConstructorDefContext ctx) {
        return new FuncDefNode(new CodePos(ctx), new FuncRegistry(ctx), (SuiteNode) visit(ctx.suite()));
    }

    @Override
    public BaseNode visitFuncDef(MxStarParser.FuncDefContext ctx) {
        return new FuncDefNode(new CodePos(ctx), new FuncRegistry(ctx), (SuiteNode) visit(ctx.suite()));
    }

    @Override
    public BaseNode visitVarDefStmt(MxStarParser.VarDefStmtContext ctx) {
    ...
    @Override
    public BaseNode visitVarDefSingle(MxStarParser.VarDefSingleContext ctx) {
    ...
    @Override
    public BaseNode visitSuite(MxStarParser.SuiteContext ctx) {
    ...
    @Override
    public BaseNode visitForStmt(MxStarParser.ForStmtContext ctx) {
    ...
    @Override
    public BaseNode visitWhileStmt(MxStarParser.WhileStmtContext ctx) {
    ...
    @Override
    public BaseNode visitIfStmt(MxStarParser.IfStmtContext ctx) {
    ...
    @Override
    public BaseNode visitSuiteStmt(MxStarParser.SuiteStmtContext ctx) {
        return new SuiteStmtNode(new CodePos(ctx), (SuiteNode) visitSuite(ctx.suite()));
    }

    @Override
    public BaseNode visitControlStmt(MxStarParser.ControlStmtContext ctx) {
    ...
    @Override
    public BaseNode visitReturnStmt(MxStarParser.ReturnStmtContext ctx) {
    ...
    @Override
    public BaseNode visitPureStmt(MxStarParser.PureStmtContext ctx) {
    ...
    @Override
    public BaseNode visitBinaryExp(MxStarParser.BinaryExpContext ctx) {
    ...
    @Override
    public BaseNode visitAssignExp(MxStarParser.AssignExpContext ctx) {
        return new AssignExpNode(new CodePos(ctx),
                (ExpBaseNode) visit(ctx.expression(0)), (ExpBaseNode) visit(ctx.expression(1)));
    }

    @Override
    public BaseNode visitFuncCallExp(MxStarParser.FuncCallExpContext ctx) {
    ...
    @Override
    public BaseNode visitIndexExp(MxStarParser.IndexExpContext ctx) {
    ...
    @Override
    public BaseNode visitLambdaExp(MxStarParser.LambdaExpContext ctx) {
    ...
    @Override
    public BaseNode visitParenExp(MxStarParser.ParenExpContext ctx) {
        return visit(ctx.expression());
    }

    @Override
    public BaseNode visitAtomExp(MxStarParser.AtomExpContext ctx) {
