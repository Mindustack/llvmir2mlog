...
define dso_local void @_Z5MfreePv(i8* %0) #0 {
  %2 = alloca i8*, align 8
...
define dso_local i8* @_Z7Mmallocj(i32 %0) #1 {
  %2 = alloca i8*, align 8
...
71:                                               ; preds = %67
  ...
  %73 = call %union.header* @_ZL9Mmorecorej(i32 %72)
...
; Function Attrs: noinline optnone uwtable
define internal %union.header* @_ZL9Mmorecorej(i32 %0) #1 {
  %2 = alloca %union.header*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
  %5 = alloca %union.header*, align 8
  store i32 %0, i32* %3, align 4
...
17:                                               ; preds = %9
  store %union.header* null, %union.header** %2, align 8
  br label %29

18:                                               ; preds = %9
  %19 = load i8*, i8** %4, align 8
  %20 = bitcast i8* %19 to %union.header*
  store %union.header* %20, %union.header** %5, align 8
  %21 = load i32, i32* %3, align 4
  %22 = load %union.header*, %union.header** %5, align 8
  %23 = bitcast %union.header* %22 to %struct.anon*
  %24 = getelementptr inbounds %struct.anon, %struct.anon* %23, i32 0, i32 1
  store i32 %21, i32* %24, align 8
  %25 = load %union.header*, %union.header** %5, align 8
  %26 = getelementptr inbounds %union.header, %union.header* %25, i64 1
  %27 = bitcast %union.header* %26 to i8*
  call void @_Z5MfreePv(i8* %27)
  %28 = load %union.header*, %union.header** @_ZL5freep, align 8
  store %union.header* %28, %union.header** %2, align 8
  br label %29

29:                                               ; preds = %18, %17
  %30 = load %union.header*, %union.header** %2, align 8
  ret %union.header* %30
}
...
declare dso_local i8* @_Z4sbrki(i32) #3
